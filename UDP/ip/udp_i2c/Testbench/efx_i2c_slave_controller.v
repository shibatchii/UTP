...
module efx_i2c_slave_controller (
    slv_scl_in,
    slv_sda_in,
    slv_scl_out,
    slv_scl_oe,
    ...
    input clk;
    input rst;
    output [DATA_BYTE_WIDTH-1:0] slv_data_out;
    input [DATA_BYTE_WIDTH-1:0] slv_din;
    input slv_read;
    input slv_write;
    output slv_busy;
    output slv_ready_to_wr;
    output slv_ready_to_rd;
    output slv_rddata_valid;
    output [7:0] slv_command_byte;

    i2c_controller_6d7d364d888b4433a8478f528dc3612a #(
...
//         / /       \   
//        / /  ..    /   i2c_controller_6d7d364d888b4433a8478f528dc3612a.v
//       / / .'     /    
//    __/ /.'      /     Description:
...
module i2c_controller_6d7d364d888b4433a8478f528dc3612a (
	clk,
    rst,
    mst_scl_in,
    mst_sda_in,
  ...
  generate
   if (I2C_MODE == "MASTER")
   i2c_master_ctl_6d7d364d888b4433a8478f528dc3612a #(
      .DATA_BYTE_WIDTH (DATA_BYTE_WIDTH),
      .I2C_FAST_MODE (I2C_FAST_MODE),
      .CLOCK_FREQ (CLOCK_FREQ),
      .SPIKE_FILTER_CYCLE (SPIKE_FILTER_CYCLE)
   ...
   i2c_slave_ctl_6d7d364d888b4433a8478f528dc3612a  #(
      .DATA_BYTE_WIDTH (DATA_BYTE_WIDTH),
      .SLAVE_ADDR (SLAVE_ADDR),
      .I2C_FAST_MODE (I2C_FAST_MODE),
      .CLOCK_FREQ (CLOCK_FREQ),
...
//          / _______    Copyright (C) 2013-2020 Efinix Inc. All rights reserved.
//         / /       \   
//        / /  ..    /   i2c_master_ctl_6d7d364d888b4433a8478f528dc3612a.v
//       / / .'     /    
//    __/ /.'      /     Description:
...
module i2c_master_ctl_6d7d364d888b4433a8478f528dc3612a
#(
    parameter DATA_BYTE_WIDTH = 32,
...
//internal signals
   ...
   //Fast2Slow Domain
   /////////////////////////////////////
   pulse_gen_fts_6d7d364d888b4433a8478f528dc3612a u_pgfts_wrflag
     (
      // Outputs
      .data_out				(write_p),
      // Inputs
   ...
   pulse_gen_fts_6d7d364d888b4433a8478f528dc3612a u_pgfts_rdflag
     (
      // Outputs
      .data_out				(read_p),
      // Inputs
   ...
   i2c_mstrslv_ctl_6d7d364d888b4433a8478f528dc3612a #(
      .I2C_FAST_MODE (I2C_FAST_MODE),
      .CLOCK_FREQ (CLOCK_FREQ),
      .SPIKE_FILTER_CYCLE (SPIKE_FILTER_CYCLE)
   ) u_i2c_mstrslv_ctl
...
//          / _______    Copyright (C) 2013-2020 Efinix Inc. All rights reserved.
//         / /       \   
//        / /  ..    /   i2c_mstrslv_ctl_6d7d364d888b4433a8478f528dc3612a.v
//       / / .'     /    
//    __/ /.'      /     Description:
...
module i2c_mstrslv_ctl_6d7d364d888b4433a8478f528dc3612a 
#(
...
//          / _______    Copyright (C) 2013-2020 Efinix Inc. All rights reserved.
//         / /       \   
//        / /  ..    /   i2c_slave_ctl_6d7d364d888b4433a8478f528dc3612a.v
//       / / .'     /    
//    __/ /.'      /     Description:
...
module i2c_slave_ctl_6d7d364d888b4433a8478f528dc3612a
#(
    parameter SLAVE_ADDR = 8'h54,
...
//          / _______    Copyright (C) 2013-2020 Efinix Inc. All rights reserved.
//         / /       \   
//        / /  ..    /   pulse_gen_fts_6d7d364d888b4433a8478f528dc3612a.v
//       / / .'     /    
//    __/ /.'      /     Description:
//   __   \       /      pulse generator
//  /_/ /\ \_____/ /     
...
module pulse_gen_fts_6d7d364d888b4433a8478f528dc3612a
    (
     //outputs.
...
endmodule // pulse_gen_fts_6d7d364d888b4433a8478f528dc3612a
