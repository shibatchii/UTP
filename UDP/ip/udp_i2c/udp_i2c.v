...
`define IP_UUID _80357bd6890e4bd9aabbb4897aaeda9f
...
//         / /       \   
//        / /  ..    /   `IP_MODULE_NAME(i2c_controller).v
//       / / .'     /    
//    __/ /.'      /     Description:
...
module `IP_MODULE_NAME(i2c_controller) (
	clk,
    rst,
    mst_scl_in,
    mst_sda_in,
...
//internal signals
   ...
   //Fast2Slow Domain
   /////////////////////////////////////
   `IP_MODULE_NAME(pulse_gen_fts) u_pgfts_wrflag
     (
      // Outputs
      .data_out				(write_p),
      // Inputs
   ...
   `IP_MODULE_NAME(pulse_gen_fts) u_pgfts_rdflag
     (
      // Outputs
      .data_out				(read_p),
      // Inputs
   ...
   `IP_MODULE_NAME(i2c_mstrslv_ctl) #(
      .I2C_FAST_MODE (I2C_FAST_MODE),
      .CLOCK_FREQ (CLOCK_FREQ),
      .SPIKE_FILTER_CYCLE (SPIKE_FILTER_CYCLE)
   ) u_i2c_mstrslv_ctl
	  ...
	  i2c_state[ST_I2C_ACK_HEADER] :
            begin
               ...
               // ack has been received, check for master/slave
		           ...
		           // not addressed, go back to IDLE, if there is repeated start
		           else begin 
		           	   if(detect_start_pulse)begin
		           	   	   i2c_next_state[ST_I2C_HEADER]=1'b1;
		           	   	   end
		           	   else begin
                       i2c_next_state[ST_I2C_IDLE] = 1'b1;
...
//          / _______    Copyright (C) 2013-2020 Efinix Inc. All rights reserved.
//         / /       \   
//        / /  ..    /   `IP_MODULE_NAME(i2c_slave_ctl).v
//       / / .'     /    
//    __/ /.'      /     Description:
...
module `IP_MODULE_NAME(i2c_slave_ctl)
#(
    parameter SLAVE_ADDR = 8'h54,
...
//          / _______    Copyright (C) 2013-2020 Efinix Inc. All rights reserved.
//         / /       \   
//        / /  ..    /   `IP_MODULE_NAME(pulse_gen_fts).v
//       / / .'     /    
//    __/ /.'      /     Description:
//   __   \       /      pulse generator
//  /_/ /\ \_____/ /     
...
module `IP_MODULE_NAME(pulse_gen_fts)
    (
     //outputs.
